...
def create_rectangle ( xmin, xmax, ymin, ymax, zmin, zmax ):
    ...
    """ original box definition when convertign from MCell3R
      Diferent from what CellBlender generates, 
      needed to unify it because it determines location
    ...
    [ 7, 3, 1 ]
    """
    # same definition of faces as generated by CellBlender
    faces = [
        [1, 2, 0],
        [3, 6, 2],
        [7, 4, 6],
