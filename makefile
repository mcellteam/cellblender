...
ZIPFILES = $(SOURCES) cellblender/io_mesh_mcell_mdl/_mdlmesh_parser.so cellblender/SimControl.jar cellblender/SimControl cellblender/data_plotters/java_plot/PlotData.jar cellblender/cellblender_id.py
