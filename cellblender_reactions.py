...
def check_reaction(self, context):
    ...
    if not mcell.cellblender_preferences.bionetgen_mode:
    ...
    if mcell.cellblender_preferences.bionetgen_mode:
        ...
        # Perform MCell Reaction Reformatting
        reactants = reactants.replace("@", " @ ")
    ...
    if mcell.cellblender_preferences.bionetgen_mode:
        # Perform BioNetGen Reaction Checking
        pass
    else:
        # Perform MCell Reaction Checking
