...
cellblender_info = {
    ...
    "cellblender_source_list": [
        ...
        "io_mesh_mcell_mdl"+os.sep+"makefile",
        ...
        "io_mesh_mcell_mdl"+os.sep+"setup.py",
        "io_mesh_mcell_mdl"+os.sep+"mdllex.l",
        "io_mesh_mcell_mdl"+os.sep+"mdlmesh_parser.c",
        "io_mesh_mcell_mdl"+os.sep+"mdlmesh_parser.h",
        "io_mesh_mcell_mdl"+os.sep+"mdlmesh_parser.i",
        "io_mesh_mcell_mdl"+os.sep+"mdlparse.h",
        "io_mesh_mcell_mdl"+os.sep+"mdlparse.y",
        "io_mesh_mcell_mdl"+os.sep+"vector.c",
        "io_mesh_mcell_mdl"+os.sep+"vector.h",
        ...
        "sim_runner_manager"+os.sep+"makefile",
        "sim_runner_manager"+os.sep+"__init__.py",

        "sim_runner_manager"+os.sep+"command_line"+os.sep+"__init__.py",
        "sim_runner_manager"+os.sep+"command_line"+os.sep+"makefile",

        "sim_runner_manager"+os.sep+"queue_local"+os.sep+"__init__.py",
        "sim_runner_manager"+os.sep+"queue_local"+os.sep+"makefile",

        "sim_runner_manager"+os.sep+"sun_grid_engine"+os.sep+"__init__.py",
        "sim_runner_manager"+os.sep+"sun_grid_engine"+os.sep+"makefile",

        "sim_runner_manager"+os.sep+"sun_grid_engine_simple"+os.sep+"__init__.py",
        "sim_runner_manager"+os.sep+"sun_grid_engine_simple"+os.sep+"makefile",

        "sim_runner_manager"+os.sep+"portable_batch_system"+os.sep+"__init__.py",
        "sim_runner_manager"+os.sep+"portable_batch_system"+os.sep+"makefile",

        "sim_runner_manager"+os.sep+"java"+os.sep+"__init__.py",
        "sim_runner_manager"+os.sep+"java"+os.sep+"SimControl.java",
        "sim_runner_manager"+os.sep+"java"+os.sep+"makefile",
        "sim_runner_manager"+os.sep+"java"+os.sep+"META-INF"+os.sep+"MANIFEST.MF",

        "sim_runner_manager"+os.sep+"open_gl"+os.sep+"__init__.py",
        "sim_runner_manager"+os.sep+"open_gl"+os.sep+"SimControl.c",
        "sim_runner_manager"+os.sep+"open_gl"+os.sep+"makefile",

        "sim_engine_manager"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"__init__.py",



        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"__init__.py",
        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"export_project_mcell_3.py",

        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"export_mcell_mdl.py",
        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"import_mcell_mdl.py",
        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"import_mcell_mdl_pyparsing.py",
        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"import_shared.py",
        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"pyparsing.py",
        #        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"mdlmesh_parser.py",
        "sim_engine_manager"+os.sep+"mcell3"+os.sep+"mdlobj.py",

        "sim_engine_manager"+os.sep+"Proto_Andreas_1"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"Proto_Andreas_1"+os.sep+"__init__.py",
        "sim_engine_manager"+os.sep+"Proto_Andreas_1"+os.sep+"run_sim.py",
        "sim_engine_manager"+os.sep+"Proto_Andreas_1"+os.sep+"minimcell.py",
        "sim_engine_manager"+os.sep+"Proto_Andreas_1"+os.sep+"emcell.py",


        "sim_engine_manager"+os.sep+"limited_python"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"limited_python"+os.sep+"__init__.py",
        "sim_engine_manager"+os.sep+"limited_python"+os.sep+"limited_python_sim.py",

        "sim_engine_manager"+os.sep+"mcell3dm"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"mcell3dm"+os.sep+"__init__.py",
        "sim_engine_manager"+os.sep+"mcell3dm"+os.sep+"data_model_to_mdl_3.py",
        "sim_engine_manager"+os.sep+"mcell3dm"+os.sep+"run_data_model_mcell_3.py",

        "sim_engine_manager"+os.sep+"mcell3r"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"mcell3r"+os.sep+"__init__.py",
        "sim_engine_manager"+os.sep+"mcell3r"+os.sep+"data_model_to_mdl_3r.py",

        "sim_engine_manager"+os.sep+"cBNGL"+os.sep+"__init__.py",

        "sim_engine_manager"+os.sep+"smoldyn248"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"smoldyn248"+os.sep+"__init__.py",

        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"makefile",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"__init__.py",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"rng.h",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"rng.cpp",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"JSON.c",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"JSON.cpp",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"JSON.h",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"JSON.java",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"libMCell.cpp",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"libMCell.h",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"libMCell.i",
#        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"libMCell.py",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"mcell_main.cpp",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"mcell_main.py",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"mcell_main_c.c",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"pure_python_sim.py",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"StorageClasses.cpp",
        "sim_engine_manager"+os.sep+"limited_cpp"+os.sep+"StorageClasses.h",
        ...
        "bng"+os.sep+"BNGSim"+os.sep+"__init__.py",
        "bng"+os.sep+"BNGSim"+os.sep+"model.py",
        "bng"+os.sep+"BNGSim"+os.sep+"pattern.py",
        "bng"+os.sep+"BNGSim"+os.sep+"result.py",
        "bng"+os.sep+"BNGSim"+os.sep+"simulator.py",
        "bng"+os.sep+"BNGSim"+os.sep+"structs.py",
        "bng"+os.sep+"BNGSim"+os.sep+"utils.py",
        "bng"+os.sep+"BNGSim"+os.sep+"worker.py",
        "bng"+os.sep+"BNGSim"+os.sep+"xmlparsers.py",
        "bng"+os.sep+"BNGSim"+os.sep+"xmltodict.py",
