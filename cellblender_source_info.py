...
cellblender_info = {
    "supported_version_list": [(2, 73, 0),(2, 74, 0),(2, 75, 0),(2, 76, 0),(2, 77, 0),(2, 78, 0),(2, 79, 0)],
    ...
    "cellblender_source_list": [
        ...
        "sim_runners"+os.sep+"sun_grid_engine_simple"+os.sep+"__init__.py",
        "sim_runners"+os.sep+"sun_grid_engine_simple"+os.sep+"makefile",
