...
cellblender_info = {
    ...
    "cellblender_source_list": [
        ...
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"common-display.js",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"histogram.css",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"histogram.html",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"__init__.py",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"plot-main-alt.css",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"plot-main.css",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"plot-main.html",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"plot-main.js",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"README.md",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"server.py",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"external"+os.sep+"all-min.css",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"external"+os.sep+"all-min.js",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"external"+os.sep+"customEvents.js",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"external"+os.sep+"exporting.js",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"external"+os.sep+"highcharts.js",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"external"+os.sep+"jquery.min.js",
        "data_plotters"+os.sep+"cellblender-plot"+os.sep+"external"+os.sep+"spectrum.css",
