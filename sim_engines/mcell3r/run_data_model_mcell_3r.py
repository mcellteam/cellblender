...
def run_mcell_sweep ( sys_argv, data_model=None ):
    ...
    for run in range (num_sweep_runs):
        ...
        for seed in range(start_seed,end_seed+1):
            ...
            data_model_to_mdl_3r.write_mdl ( dm, os.path.join(sweep_item_path, '%s.main.mdl' % (base_name) ) )
...
if __name__ == "__main__":
    print ( "run_data_model_mcell_3r.py running from " + str(os.getcwd()) )
