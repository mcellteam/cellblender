fceri_mcell3r_dm = {
    ...
    'molecule_list' : [
      {
        ...
        'display' : {
          'color' : [0.07522483915090561, 0.5478159785270691, 1.0],
          'emit' : 0.0,
          'glyph' : "Torus",
          'scale' : 7.0
        },
      ...
      },
      {
        ...
        'diffusion_constant' : "8.51e-7",
        'display' : {
          'color' : [0.008227385580539703, 1.0, 0.0],
          'emit' : 2.0,
          'glyph' : "Cube",
          'scale' : 5.0
        },
      ...
      },
      {
        ...
        'diffusion_constant' : "1.7e-7",
        'display' : {
          'color' : [1.0, 0.27324050664901733, 0.029770098626613617],
          'emit' : 0.0,
          'glyph' : "Receptor",
          'scale' : 5.0
        },
  ...
  'geometrical_objects' : {
    'object_list' : [
      ...
      },
      {
        ...
        'name' : "CP",
        'vertex_list' : [
          [0.5, 0.4999999701976776, -0.5],
          [0.5, -0.5, -0.5],
          [-0.5000000596046448, -0.49999991059303284, -0.5],
          [-0.4999998211860657, 0.5000001788139343, -0.5],
          [0.5000002384185791, 0.4999997317790985, 0.5],
          [0.49999967217445374, -0.5000002980232239, 0.5],
          [-0.5000001788139343, -0.4999998211860657, 0.5],
  ...
  'materials' : {
    'material_dict' : {
      'CP_mat' : {
        'diffuse_color' : {
          'a' : 0.38181817531585693,
          'b' : 0.7287074327468872,
          'g' : 0.0,
      ...
      'EC_mat' : {
        'diffuse_color' : {
          ...
          'b' : 0.42922598123550415,
          'g' : 0.4186386466026306,
          'r' : 0.4266946315765381
        }
      }
    }
  },
