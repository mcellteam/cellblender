simple_chain_mcell3r_dm = {
    ...
    'molecule_list' : [
      {
        ...
        'description' : "",
        'diffusion_constant' : "diffusion_const",
        'display' : {
    ...
    'reaction_list' : [
      {
        ...
        'description' : "",
        'fwd_rate' : "kp1",
        'name' : "M(l)+M(r) -> M(l!1).M(r!1)",
        'products' : "M(l!1).M(r!1)",
        'reactants' : "M(l)+M(r)",
        'rxn_name' : "",
    ...
    'object_list' : [
      {
        ...
        'name' : "CP",
        'vertex_list' : [
          [1.0, 0.9999999403953552, -0.009999999776482582],
          [1.0, -0.9999999403953552, -0.009999999776482582],
          [-1.0, -0.9999999403953552, -0.009999999776482582],
          [-1.0, 0.9999999403953552, -0.009999999776482582],
          [1.0, 0.9999999403953552, 0.009999999776482582],
  ...
  'mol_viz' : {
    ...
    'viz_enable' : True,
    'viz_list' : ['mol_volume_proxy', 'mol_M']
  },
  'parameter_system' : {
    'model_parameters' : [
      {
      ...
      {
        'par_description' : "",
        'par_expression' : "1e8 + ( 0 * (cTot*koff)/(3.0*Lig_tot)*Nav ) * reaction_multiplier",
        'par_name' : "kp1",
        'par_units' : "",
        'sweep_enabled' : False,
      },
      {
        'par_description' : "",
        'par_expression' : "0 * 0.0016666667*Nav * reaction_multiplier",
        'par_name' : "kp2",
        'par_units' : "",
        'sweep_enabled' : False,
      },
    ...
    'reaction_output_list' : [
      {
        ...
        'mdl_file_prefix' : "Lig",
        'mdl_string' : "COUNT[M(l,r), WORLD]",
        'molecule_name' : "M",
        'name' : "MDL: COUNT[M(l,r), WORLD]",
        'object_name' : "",
