...
class MCELL_OT_run_simulation(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if str(mcell.run_simulation.simulation_run_control) == 'JAVA':
            ...
            bpy.ops.mcell.run_simulation_queue()
        return {'FINISHED'}
...
class MCELL_OT_run_simulation_control_queue(bpy.types.Operator):
    bl_idname = "mcell.run_simulation_queue"
    bl_label = "Run MCell Simulation Command Queue"
    bl_description = "Run MCell Simulation Command Queue"
    bl_options = {'REGISTER'}
